    ...
    def setDependencies(self,name,b):
        ...
        if name in ["gain","E","rmx","gainE","gainReconmxT","decayFactor"]:
            ...
            try:
                ...
                return
            if rmx is not None:
                rmxt=rmx.transpose().astype(numpy.float32,order="C") # order is important here as otherwise memory is not C-contiguous
                nacts=g.shape[0]
